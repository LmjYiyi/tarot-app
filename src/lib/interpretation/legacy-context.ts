...
function resolveSelectedCards(
  ...
  return cards
    ...
    .filter((value): value is LegacySelectedCard => Boolean(value));
}
...
export async function buildLegacyInterpretationPayload(input: BuildLegacyContextInput) {
