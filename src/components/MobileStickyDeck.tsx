  ...
  return (
    <AnimatePresence>
      {visible ? (
        ...
        >
          <div className="pointer-events-auto mx-auto max-w-[680px] rounded-[18px] border border-[var(--coral-edge)] bg-[rgba(251,240,200,0.92)] px-3 py-2.5 shadow-[0_18px_42px_rgba(74,59,50,0.18)] backdrop-blur-md">
            <div className="mb-1.5 flex items-center gap-2">
              <span className="font-occult text-[9px] uppercase tracking-[0.32em] text-[var(--coral-deep)]">
                Mensa · {spread.cardCount}
              </span>
              <span className="h-px flex-1 bg-gradient-to-r from-[var(--coral-edge)] via-[var(--coral-edge)]/40 to-transparent" />
            </div>
            <div
              className={cn(
            ...
            >
              {cards.map(({ card, reversed, positionOrder }) => {
                ...
                return (
                  ...
                  >
                    <span
                      className="w-full truncate text-center font-occult text-[8px] uppercase leading-tight tracking-[0.18em] text-[var(--ink-soft)]"
                      title={position.name}
                    >
                      {position.name}
                    </span>
                    <div className="relative w-full overflow-hidden rounded-[6px] border border-[var(--coral-edge)] bg-[var(--surface-tint)] shadow-[0_3px_10px_rgba(74,59,50,0.16)]">
                      ...
                      {reversed ? (
                        <span className="absolute inset-x-0 bottom-0 bg-[var(--coral-deep)]/90 py-px text-center font-occult text-[7px] tracking-[0.22em] text-[var(--surface-tint)]">
                          REV
                        </span>
                      ) : null}
                    </div>
